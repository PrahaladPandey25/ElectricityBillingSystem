...
public class CalculateBill extends JFrame implements ActionListener{
    ...
    CalculateBill() {
       ...
       try {
        ...
        JLabel lblstate = new JLabel("Moth");
   ...
   public void actionPerformed(ActionEvent ae) {
       if(ae.getSource() == next ) {
           ...
           int totalbill = 0;
           int unit_consume = Integer.parseInt(units);
           ...
           String query2 = "insert into bill values('"+meter+"', '"+month+"', '"+units+"', '"+totalbill+"', 'Not Piad')";
