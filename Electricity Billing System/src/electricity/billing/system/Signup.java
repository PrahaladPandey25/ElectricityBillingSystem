...
public class Signup extends JFrame implements ActionListener {
    ...
    Signup() {
        ...
        setBounds(450, 150, 700, 400);  // setSize(700, 400); setLocation(450, 150);
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource() == create) {
            String stype = accountType.getSelectedItem();
            ...
            try {
                ...
                query = "insert into login values('"+smeter+"', '"+susername+"', '"+sname+"', '"+spassword+"', '"+stype+"')";
                    ...
                    query = "update login set username = '"+susername+"', password = '"+spassword+"', user = '"+stype+"' where meter_no = '"+smeter+"'";
                }
